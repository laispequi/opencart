...
<script type="text/javascript" src="catalog/view/javascript/appleberry_400.font.js"></script>
...
<body>
	...
	<div id="header">
        ...
        <!--<div class="links">
            <a href="<?php echo $home; ?>"><?php echo $text_home; ?>
            </a>
            ...
            <a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?>
            </a>
        </div>-->
